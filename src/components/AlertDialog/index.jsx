...
function DeleteAlertDialog({ handleDelete }) {
  return (
    <AlertDialog>
      ...
      <AlertDialogContent>
        ...
        <AlertDialogDescription>
          Esta ação não pode ser desfeita. Isso removerá permanentemente o registro do banco de
          dados.
        </AlertDialogDescription>
        <Flex css={{ justifyContent: 'flex-end' }}>
          ...
          <AlertDialogAction asChild>
            <Button onClick={handleDelete} variant="red">Sim, remover</Button>
          </AlertDialogAction>
        </Flex>
      </AlertDialogContent>
    </AlertDialog>
